...
public class ActivityTranslateBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.activityName, 1);
    }
    // views
    @NonNull
    ...
    public ActivityTranslateBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.activityName = (com.lst11.learnpolish.presentation.utils.TopBarView) bindings[1];
